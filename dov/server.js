// 
//  server.js
//  dov - An example node.js API server for the DoV game engine.
//  
//  Created by Daniel Harris on 2010-09-24.
//  Copyright 2010 Staer, Inc. All rights reserved.
// 
// =================================================================================
// = Uncomment the following section to validate with the Google Closure Compiler.
// = Closure doesn't know about certain functions available to Node.js so we have
// = to define a few skeleton functions.
// =================================================================================
...
var SETTINGS = {
	...
	'port': '8124',
	// Location of the static files to serve over HTTP
	'webroot': './web/',
	// Game server host
	'GS_host': 'DOV',
	// Game server port
	'GS_port': '31415',
	// Debug mode (prints addition info to the console)
	'debug': true
};
